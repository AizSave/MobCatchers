...
public class BwSwampDweller extends SwampDwellerMob {

    public BwSwampDweller() {
        super();
    ...
    public void init() {
        ...
        this.ai = new BehaviourTreeAI<>(this, new ConfusedHostileChaserWandererAI<BwSwampDweller>(null, 512, 320, 40000, false, false) {
            public boolean attackTarget(BwSwampDweller mob, Mob target) {
