...
public class BwEnchantedZombie extends EnchantedZombieMob {

    public BwEnchantedZombie() {
        super();
    ...
    public void init() {
        super.init();
        this.ai = new BehaviourTreeAI<>(this, new ConfusedCollisionHostileChaserWandererAI<>(null, 480, new GameDamage(35.0F), 100, 40000));
        this.isHostile = false;
        this.setTeam(-1);
    }
