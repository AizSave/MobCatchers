...
public class BwSkeletonTrhower extends SkeletonThrowerMob {

    public BwSkeletonTrhower() {
        super();
    ...
    public void init() {
        ...
        this.ai = new BehaviourTreeAI<>(this, new ConfusedHostileChaserWandererAI<BwSkeletonTrhower>(null, 512, 320, 40000, false, false) {
            public boolean attackTarget(BwSkeletonTrhower mob, Mob target) {
                boolean success = this.shootSimpleProjectile(mob, target, "bone", damage, 90, 640);
                if (success) {
