...
public class BwSwampSlime extends SwampSlimeMob {
    ...
    public void init() {
        super.init();
        this.ai = new BehaviourTreeAI<>(this, new ConfusedCollisionHostileChaserWandererAI<>(null, 160, new GameDamage(40.0F), 100, 40000));
        this.isHostile = false;
        this.setTeam(-1);
    }
