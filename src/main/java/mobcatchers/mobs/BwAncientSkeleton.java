...
public class BwAncientSkeleton extends AncientSkeletonMob {

    public BwAncientSkeleton() {
        super();
    ...
    public void init() {
        ...
        this.ai = new BehaviourTreeAI<>(this, new ConfusedCollisionHostileChaserWandererAI<>(null, 512, damage, 100, 40000));
        this.isHostile = false;
        this.setTeam(-1);
    }
