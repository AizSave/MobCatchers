...
public class BwSkeletonMiner extends SkeletonMinerMob {

    public BwSkeletonMiner() {
        super();
    ...
    public void init() {
        super.init();
        this.ai = new BehaviourTreeAI<>(this, new ConfusedCollisionHostileChaserWandererAI<>(null, 512, new GameDamage(55.0F), 100, 40000));
        this.isHostile = false;
        this.setTeam(-1);
    }
