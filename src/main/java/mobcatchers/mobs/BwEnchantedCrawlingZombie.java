...
public class BwEnchantedCrawlingZombie extends EnchantedCrawlingZombieMob {

    public BwEnchantedCrawlingZombie() {
        super();
    ...
    public void init() {
        super.init();
        this.ai = new BehaviourTreeAI<>(this, new ConfusedCollisionHostileChaserWandererAI<>(null, 480, new GameDamage(30.0F), 100, 40000));
        this.isHostile = false;
        this.setTeam(-1);
    }
